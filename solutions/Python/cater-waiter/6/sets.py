...
def categorize_dish(dish_name, dish_ingredients):
    ...
    # If none of the if conditions match, return an unknow category.
    return str(dish_name) + ": UNKNOWN"
...
def singleton_ingredients(dishes, intersection):
    ...
    singleton_ingredients_remaining = all_ingredients - duplicate_ingredients
    
    return singleton_ingredients_remaining
